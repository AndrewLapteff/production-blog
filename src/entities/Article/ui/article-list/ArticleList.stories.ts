...
import { articleReducer, ArticleType } from '../../../Article'
...
export const ArticleListClassicLight: Story = {
  args: {
    articles,
    isLoading: false,
    view: 'classic'
...
export const ArticleListClassicDark: Story = {
  args: {
    articles,
    isLoading: false,
    view: 'classic'
...
export const ArticleListClassicLightLoading: Story = {
  args: {
    articles,
    isLoading: true,
    view: 'classic'
...
export const ArticleListClassicDarkLoading: Story = {
  args: {
    articles,
    isLoading: true,
    view: 'classic'
...
export const ArticleListCompactLight: Story = {
  args: {
    articles,
    isLoading: false,
    view: 'compact'
...
export const ArticleListCompactDark: Story = {
  args: {
    articles,
    isLoading: false,
    view: 'compact'
...
export const ArticleListCompactLightLoading: Story = {
  args: {
    articles,
    isLoading: true,
    view: 'compact'
...
export const ArticleListCompactDarkLoading: Story = {
  args: {
    articles,
    isLoading: true,
    view: 'compact'
